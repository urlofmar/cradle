...
TEST_CASE("URL type string", "[thinknode]")
{
    ...
    auto named_type = make_api_type_info_with_named_type(named_info);
    REQUIRE(get_url_type_string(named_type) == "named/my_account/my_app/my_type");

    auto integer_type = make_api_type_info_with_integer_type(api_integer_type());
    ...
    auto boolean_type = make_api_type_info_with_boolean_type(api_boolean_type());
    ...
    auto dynamic_type = make_api_type_info_with_dynamic_type(api_dynamic_type());
    ...
    auto datetime_type = make_api_type_info_with_datetime_type(api_datetime_type());
    REQUIRE(get_url_type_string(datetime_type) == "datetime");

    api_array_info array_info;
    array_info.element_schema = boolean_type;
    auto array_type = make_api_type_info_with_array_type(array_info);
    ...
    auto map_type = make_api_type_info_with_map_type(map_info);
    ...
    auto struct_type = make_api_type_info_with_structure_type(struct_info);
    ...
    auto union_type = make_api_type_info_with_union_type(union_info);
    ...
    auto enum_type = make_api_type_info_with_enum_type(enum_info);
...
TEST_CASE("ISS POST", "[thinknode]")
{
    ...
    auto id =
        post_iss_object(
            ...
            session,
            "123",
            make_api_type_info_with_string_type(api_string_type()),
            value("payload"));
    REQUIRE(id == "def");
}
