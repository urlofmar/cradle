...
static const std::string separators("cfhistuCFHISTU");
...
std::string&
Hashids::_reorder(std::string& input, const std::string& salt) const
{
    if (salt.empty())
        return input;
...
std::string
Hashids::_reorder_norewrite(
    const std::string& input, const std::string& salt) const
{
...
std::string
Hashids::_hash(uint64_t number, const std::string& alphabet) const
{
    std::string output;
    do
    {
...
std::string
Hashids::encodeHex(const std::string& input) const
{
...
std::string
Hashids::decodeHex(const std::string& input) const
{
...
uint64_t
Hashids::_unhash(const std::string& input, const std::string& alphabet) const
{
...
void
Hashids::_ensure_length(
    std::string& output, std::string& alphabet, int values_hash) const
{
...
Hashids::_split(const std::string& input, const std::string& splitters) const
{
...
std::vector<uint64_t>
Hashids::decode(const std::string& input) const
{
