...
// This file provides functions for converting raw binary data to and from a base64 ASCII
// encoding. The characters used to represent the 64 values are specified as a function
// parameter. Two obvious choices are provided here: the MIME character set and a modified
// MIME set that is URL-friendly.

namespace cradle {

// Given the length of a raw binary sequence, this gives the maximum length of the
// corresponding base64 encoding, including the terminating null character.
// The actual length of the encoded sequence may be shorter by one or two characters.
size_t
get_base64_encoded_length(size_t raw_length);

// Given the length of a base64 encoded sequence, this gives the maximum length of
// corresponding decoded binary sequence.
// The actual length of the decoded sequence may be shorter by one or two bytes.
size_t
...
base64_character_set static inline
