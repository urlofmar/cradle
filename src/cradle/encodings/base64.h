#ifndef CRADLE_ENCODINGS_BASE64_H
#define CRADLE_ENCODINGS_BASE64_H
...
// the MIME character set and a modified MIME set that is URL-friendly.
...
string
base64_decode(
    string const& encoded, base64_character_set const& character_set);
