...
struct type_info_query<nil_t>
{
    ...
    {
        *info = construct_api_type_info_with_nil(api_nil_type());
    }
};
...
struct type_info_query<bool>
{
    ...
    get(api_type_info* info)
    {
        *info = construct_api_type_info_with_boolean(api_boolean_type());
    }
};
...
#define CRADLE_DECLARE_INTEGER_INTERFACE(T) \
    ...
    { \
        ...
        get(api_type_info* info) \
        { \
            *info = construct_api_type_info_with_integer(api_integer_type()); \
        } \
    }; \
    \
    integer \
...
#define CRADLE_DECLARE_FLOAT_INTERFACE(T) \
    ...
    { \
        ...
        get(api_type_info* info) \
        { \
            *info = construct_api_type_info_with_float(api_float_type()); \
        } \
    }; \
    CRADLE_DECLARE_NUMBER_INTERFACE(T)
...
struct type_info_query<string>
{
    ...
    get(api_type_info* info)
    {
        *info = construct_api_type_info_with_string(api_string_type());
    }
};
...
struct type_info_query<ptime>
{
    ...
    get(api_type_info* info)
    {
        *info = construct_api_type_info_with_datetime(api_datetime_type());
    }
};
...
struct type_info_query<blob>
{
    ...
    get(api_type_info* info)
    {
        *info = construct_api_type_info_with_blob(api_blob_type());
    }
};
...
struct type_info_query<std::vector<T>>
{
    ...
    get(api_type_info* info)
    {
        ...
        *info = construct_api_type_info_with_array(array_info);
    }
};
...
struct type_info_query<std::map<Key,Value>>
{
    ...
    get(api_type_info* info)
    {
        ...
        *info = construct_api_type_info_with_map(map_info);
    }
};
...
struct type_info_query<optional<T>>
{
    ...
    get(api_type_info* info)
    {
        *info = construct_api_type_info_with_optional(get_type_info<T>());
    }
};
